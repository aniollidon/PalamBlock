...
chrome.storage.local.get(
  ["alumne", "server", "secondaryServer", "extVersion"],
  (result) => {
    ...
    if (result.secondaryServer && result.secondaryServer !== "") {
      document.getElementById("servidor-secundari").innerText =
        result.secondaryServer;
    } else {
      document.getElementById("servidor-secundari").innerText =
        DEFAULT_SECONDARY_SERVER;
    }
